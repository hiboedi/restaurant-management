...
func GetFoods() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured listing foods"})
		}
		var allFoods []bson.M
...
func GetFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured whike fetching the food item"})
		}
...
func CreateFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if insertErr != nil {
			msg := fmt.Sprintf("Fail to create food")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		defer cancel()
...
func UpdateFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("failed to update food item")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		c.JSON(http.StatusOK, result)
