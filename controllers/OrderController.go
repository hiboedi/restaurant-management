...
func GetOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured whike fetching the order item"})
		}
...
func CreateOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if insertErr != nil {
			msg := fmt.Sprintf("Fail to create order")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		defer cancel()
...
func UpdateOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("failed to update order item")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		defer cancel()
